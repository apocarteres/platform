...
| [Центр поддержки: starter `platform-support` и пакет `@apocarteres/support`](CORE-ARC-017-support-centre.md) | P2 | Запланирована | Не назначен | frontend, backend, architecture, personal-data |
