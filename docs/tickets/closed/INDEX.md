...
Всего: 74. Включены самостоятельные задачи и этапы планов функций.
...
| [Терминология ядра не закреплена](CORE-DOC-011-terminology-is-not-fixed.md) | P1 | Выполнена | Не назначен | documentation, process |
