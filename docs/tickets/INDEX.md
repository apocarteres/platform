...
|---|---|---|---|---|
| [Модальное окно явно решает, что делать по Escape](CORE-ARC-007-modal-escape-decision-is-explicit.md) | P1 | Запланирована | [RELEASE-2-0-0](../releases/RELEASE-2-0-0.md) | frontend, architecture |
