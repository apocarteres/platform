...
|---|---|---|---|---|
| [Ядро не исполняет собственного требования о статическом разборе](CORE-QUAL-011-core-does-not-do-what-it-requires.md) | P0 | Запланирована | [RELEASE-1-20-0](../releases/RELEASE-1-20-0.md) | quality, build |
