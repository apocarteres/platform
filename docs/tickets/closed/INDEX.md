...
| [Обязательство сослалось на правило, которого у потребителя нет](CORE-OPS-037-obligation-points-at-an-undelivered-rule.md) | P1 | Выполнена | Не назначен | process, tooling |
