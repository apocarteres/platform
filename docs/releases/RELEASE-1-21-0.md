...
|---|---|
| [CORE-OPS-048](../tickets/closed/CORE-OPS-048-rule-reads-a-neighbours-working-copy.md) | Указана при открытии выпуска |
| [CORE-QUAL-013](../tickets/closed/CORE-QUAL-013-forbid-leaves-no-way-to-declare-an-exemption.md) | Указана при открытии выпуска |
