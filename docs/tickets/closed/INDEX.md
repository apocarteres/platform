...
Всего: 29. Включены самостоятельные задачи и этапы планов функций.
...
| [Миграция формата задач clanlog](DOC-003-clanlog-ticket-format-migration.md) | P2 | Выполнена | Не назначен | process, documentation |
