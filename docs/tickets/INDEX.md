...
|---|---|---|---|---|
| [Неопознанный отказ не оставлял следа](CORE-API-008-unexplained-failure-left-no-trace.md) | P0 | Запланирована | [RELEASE-1-47-0](../releases/RELEASE-1-47-0.md) | api, observability |
