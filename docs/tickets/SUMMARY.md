...
|---|---|---|---|---|
| [Правила кода из платформы: контракт, проверка и внедрение](code-comments-rule.md) | P1 | В работе | Не назначен | process, tooling, backend, frontend |
...
- [Правила ведения задач](RULES.md)
