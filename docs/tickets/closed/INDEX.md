...
Всего: 19. Включены самостоятельные задачи и этапы планов функций.
...
| [Сборка сервиса оставляла в дереве плоский POM](service-build-left-a-flattened-pom.md) | P2 | Выполнена | [RELEASE-0-32-0](../../releases/RELEASE-0-32-0.md) | build, platform |
