...
|---|---|---|---|---|
| [Манифест и журнал развёртывания написаны дважды](CORE-OPS-067-manifest-and-journal-from-the-declaration.md) | P1 | Запланирована | Не назначен | deployment, tooling |
