...
Всего: 8. Включены самостоятельные задачи и этапы планов функций.
...
| [Проверки документации не знали о собственных данных цикла выпусков](docs-checks-unaware-of-release-cycle.md) | P1 | Выполнена | Не назначен | documentation, release |
...
| [Ссылка на нормативный документ ядра считалась ссылкой в пустоту](references-to-delivered-core-documents.md) | P2 | Выполнена | Не назначен | documentation |
