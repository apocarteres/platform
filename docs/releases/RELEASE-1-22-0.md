...
|---|---|
| [CORE-OPS-049](../tickets/closed/CORE-OPS-049-component-replacement-without-an-inventory.md) | Указана при открытии выпуска |
| [CORE-OPS-050](../tickets/closed/CORE-OPS-050-core-builds-the-artifact-but-says-nothing-about-launching-it.md) | Указана при открытии выпуска |
| [CORE-OPS-051](../tickets/closed/CORE-OPS-051-aot-cache-as-a-recommendation.md) | Указана при открытии выпуска |
