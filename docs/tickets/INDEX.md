...
|---|---|---|---|---|
| [Шаг сборки и отпечаток зависимостей написаны дважды](CORE-OPS-063-step-contract-and-dependency-fingerprint.md) | P1 | Запланирована | Не назначен | build, tooling |
