...
| [Смена почты и удаление учётной записи ядра](CORE-ARC-019-change-email-and-delete-account.md) | P1 | Выполнена | [RELEASE-10-0-0](../../releases/RELEASE-10-0-0.md) | backend, frontend, security, personal-data |
...
| [Установка ядра собирает клиентские пакеты столько раз, сколько их](CORE-OPS-101-install-local-builds-once.md) | P2 | Выполнена | [undefined](../../releases/undefined.md) | publishing, tooling, testing |
