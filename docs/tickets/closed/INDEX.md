...
Всего: 155. Включены самостоятельные задачи и этапы планов функций.
...
| [Шлагбаум перед отправкой перестал проверять документы, принятая идея не проходила проверку](CORE-OPS-091-hook-lost-docs-check.md) | P1 | Выполнена | Не назначен | tickets, tooling, quality |
