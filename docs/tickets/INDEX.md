...
| [OpenAPI-контракт аутентификации ядра и типизированный профиль проекта](CORE-ARC-015-openapi-contract-for-core-auth.md) | P2 | Запланирована | Не назначен | backend, frontend, api, tooling |
