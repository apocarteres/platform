...
| [Родитель сервиса терял классы проекта в интеграционных тестах](service-parent-lost-the-integration-test-classpath.md) | P1 | Выполнена | Не назначен | build, platform |
