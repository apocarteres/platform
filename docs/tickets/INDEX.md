...
|---|---|---|---|---|
| [Проверка работоспособности соответствовала требованию и не проверяла ничего](CORE-OPS-060-health-check-confirmed-nothing.md) | P0 | Запланирована | Не назначен | deployment, tooling |
