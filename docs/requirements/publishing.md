...
8. <a id="REQ-PUBLISHING-008"></a> **REQ-PUBLISHING-008** — Работа ведётся в ветке `main`; тег выпуска ставится на её коммит, прошедший проверки. Релизных веток нет: исправление в опубликованной версии выходит следующей patch-версией из `main`.
9. <a id="REQ-PUBLISHING-009"></a> **REQ-PUBLISHING-009** — Опубликованная версия неизменна. Ошибочный выпуск не перепубликуется под тем же номером и не удаляется из registry; вместо этого выпускается следующая версия.
