...
|---|---|---|---|---|
| [Этапом плана нельзя назвать коммит](CORE-OPS-045-plan-stage-cannot-name-a-commit.md) | P1 | Запланирована | [RELEASE-1-19-0](../releases/RELEASE-1-19-0.md) | tooling |
| [Отказ коммиту без задачи не называет выхода](CORE-OPS-046-refusal-without-a-way-out.md) | P1 | Запланирована | [RELEASE-1-19-0](../releases/RELEASE-1-19-0.md) | tooling |
