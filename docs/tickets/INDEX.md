...
|---|---|---|---|---|
| [Два требования одной поставки исключали друг друга](CORE-OPS-058-two-requirements-exclude-each-other.md) | P0 | Запланирована | Не назначен | deployment |
| [Доставленная настройка полагалась на состав группы, а не объявляла правило](CORE-QUAL-019-delivered-config-relied-on-a-lint-group.md) | P0 | Запланирована | Не назначен | rust, quality |
| [У Rust нет средства засева, хотя правило его разрешает](CORE-QUAL-020-rust-has-no-seeding-mechanism.md) | P1 | Запланирована | Не назначен | rust, quality |
